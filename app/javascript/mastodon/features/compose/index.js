      ...
      header = (
        <nav className='drawer__header'>
          ...
          {!columns.some(column => column.get('id') === 'HASHTAG') && (
            <Link to='/timelines/tag/abyss_fun' className='drawer__tab' title={intl.formatMessage(messages.old_community)} aria-label={intl.formatMessage(messages.old_community)}><Icon id='comments' /></Link
