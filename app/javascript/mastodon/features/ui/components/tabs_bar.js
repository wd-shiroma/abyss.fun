...
export const links = [
  ...
  <NavLink className='tabs-bar__link secondary' exact to='/timelines/tag/abyss_fun' data-preview-title-id='column.old_local_timeline' data-preview-icon='comments' ><Icon id='comments' /><FormattedMessage id='tabs_bar.old_community_timeline' defaultMessage='Old local' /></NavLink>,
